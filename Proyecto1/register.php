...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <video autoplay muted loop src="./video/video_register1.mp4" class="d-block w-100" alt="video 1" ></video>
            </div>
            <div class="carousel-item">
              <video autoplay muted loop src="./video/video_register2.mp4" class="d-block w-100" alt="video 2" ></video>
            </div>
          </div>
      ...
      <div class="col-md-6"> 
        <form id="usuarioForm" class="bg-light p-4 rounded shadow-sm" action="./backend/register.php" method="post"> 
